...
tokens = [
    ...
    'assignment',
    #界符
    'bracel', 'bracer', 'parenl', 'parenr', 'comma', 'semi', 'annotation',
    #常量
    'NUMINT','NUMFLOAT',
    #标识符
    'ID',
...
def t_error(t):
    ...
    #print("========Illegal character: {t.value[0]}   line: {str(t.lineno)}   col: {str(tmp)}")
...
# 测试输入文件与结果输出文件
f = open('test_input/1.c', 'r', encoding='UTF-8')
